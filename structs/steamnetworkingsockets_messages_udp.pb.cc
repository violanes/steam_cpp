...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_steamnetworkingsockets_5fmessages_5fudp_2eproto_getter() {
...
void CMsgSteamSockets_UDP_ChallengeRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_ChallengeRequest *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_ChallengeRequest &>(from));
}
...
void CMsgSteamSockets_UDP_ChallengeReply::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_ChallengeReply *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_ChallengeReply &>(from));
}
...
// @@protoc_insertion_point(message_byte_size_start:CMsgSteamSockets_UDP_ConnectRequest)
  ...
  if (cached_has_bits & 0x00000300u) {
    ...
    // optional uint32 legacy_protocol_version = 8;
    if (cached_has_bits & 0x00000200u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_legacy_protocol_version());
    }
...
void CMsgSteamSockets_UDP_ConnectRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_ConnectRequest *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_ConnectRequest &>(from));
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 17)) {
          ...
          legacy_server_steam_id_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
...
void CMsgSteamSockets_UDP_ConnectOK::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_ConnectOK *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_ConnectOK &>(from));
}
...
void CMsgSteamSockets_UDP_ConnectionClosed::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_ConnectionClosed *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_ConnectionClosed &>(from));
}
...
void CMsgSteamSockets_UDP_NoConnection::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_NoConnection *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_NoConnection &>(from));
}
...
void CMsgSteamSockets_UDP_Stats::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CMsgSteamSockets_UDP_Stats *>(to)->MergeFrom(
      static_cast<const CMsgSteamSockets_UDP_Stats &>(from));
}
