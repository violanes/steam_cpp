...
class CSystemManager_Hibernate_Request final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:CSystemManager_Hibernate_Request) */ {
 public:
  ...
  CSystemManager_Hibernate_Request* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class CSystemManager_Hibernate_Response final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:CSystemManager_Hibernate_Response) */ {
 public:
  ...
  CSystemManager_Hibernate_Response* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
