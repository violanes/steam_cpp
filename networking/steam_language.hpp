#ifndef STEAM_LANGUAGE
#define STEAM_LANGUAGE

#include <iostream>
#include <vector>

inline std::vector<uint8_t> g_public_key = {
...
struct msg_header {
	std::uint32_t msg = 0;
	std::uint64_t target_job_id = UINT64_MAX;
	std::uint64_t source_job_id = UINT64_MAX;
};
